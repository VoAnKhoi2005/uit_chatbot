...
DEFAULT_TRIPLETS_PATH = Path("graph/mongo_export_uit/KB_UIT.triplets.json")
DEFAULT_ITEMS_PATH = Path("graph/mongo_export_uit/KB_UIT.items.json")
DEFAULT_TTL_PATH = Path("ontology/uit_regulations.ttl")
